...
public:
	...
	// конструктор, который принимает логин, электронную почту и пароль в качестве аргументов и инициализирует соответствующие пол€. ќстальные пол€ устанавливаютс€ по умолчанию.
